...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_ckpt', help="restore checkpoint", default="./checkpoints/kitti_2015.pth") 
    ...
    parser.add_argument('--output_directory', help="directory to save output", default="./Output/kitti/2015") 
