...
def validate_middlebury(model, iters=32, split='MiddEval3', resolution='F', mixed_prec=False):
    ...
    print(f"Validation Middlebury{split}_{resolution}: EPE {epe}, D1 {d1}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--corr_radius', type=list, default=[2, 2, 4], help="width of the correlation pyramid")
    ...
    if args.dataset == 'eth3d':
        ...
        validate_middlebury(model, iters=args.valid_iters, split='MiddEval3', resolution='H', mixed_prec=use_mixed_precision)
