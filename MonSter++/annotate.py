...
def annotate(args):
    ...
    with torch.no_grad():
        ...
        for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
            frame_name = re.sub("_[lr].jpeg", "", Path(imfile1).name)

            assert Path(imfile2).name.startswith(frame_name), f"{imfile2} does not match {frame_name}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_ckpt', help="restore checkpoint", default="checkpoints/Mix_all_large.pth")

    parser.add_argument('--save_numpy', action='store_true', help='save output as numpy arrays')

    parser.add_argument('-l', '--left_imgs', help="glob for left frames", default="/home/sch/datasets/deliverator-stereo/images/*_l.jpeg")
    parser.add_argument('-r', '--right_imgs', help="glob for right frames", default="/home/sch/datasets/deliverator-stereo/images/*_r.jpeg")

    parser.add_argument('--output_directory', help="directory to save output", default="/home/sch/datasets/deliverator-stereo/disparity/")
